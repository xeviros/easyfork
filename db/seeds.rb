...
Item.create!(category: "drinks", name: "cappuccino", price: 10, restaurant: resto2)
Item.create!(category: "drinks", name: "tea", price: 10, restaurant: resto3)
Item.create!(category: "drinks", name: "mojito", price: 10, restaurant: resto2)
...
Item.create!(category: "desserts", name: "Icecream", description: "lemon, mint, vanilla", price: 10, restaurant: resto3)
